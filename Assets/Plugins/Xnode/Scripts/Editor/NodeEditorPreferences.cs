...
namespace XNodeEditor {
    ...
    public static class NodeEditorPreferences {
        ...
        public class Settings : ISerializationCallbackReceiver {
            ...
            public Color FunctionColor, BranchColor, ValueColor;
        ...
        private static void GridSettingsGUI(string key, Settings settings) {
            ...
            settings.FunctionColor = EditorGUILayout.ColorField(new GUIContent("Function Color", "Color of Function Node"), settings.FunctionColor);
            settings.BranchColor = EditorGUILayout.ColorField(new GUIContent("Branch Color", "Color of Branch Node"), settings.BranchColor);
            settings.ValueColor = EditorGUILayout.ColorField(new GUIContent("Value Color", "Color of Value Node"), settings.ValueColor);
