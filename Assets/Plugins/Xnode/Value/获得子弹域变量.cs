	...
	public class 获得子弹域变量 : Node
	{
		...
		public void 刷新()
		{
			...
			switch (类型)
			{
				...
				case ValueType.激光:
					if (不声明数组)
						AddDynamicOutput(typeof(LaserShooting), ConnectionType.Multiple, TypeConstraint.None, "输出");
					else
						AddDynamicOutput(typeof(List<LaserShooting>), ConnectionType.Multiple, TypeConstraint.None, "输出");
